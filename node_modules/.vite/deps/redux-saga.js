...
import { $ as shouldCancel, At as TERMINATE, C as compose, Ct as MATCH, D as createSetContextWarning, Dt as SELF_CANCELLATION, E as createEmptyArray, Et as SAGA_LOCATION, G as noop, H as logError, I as getLocation, K as once, L as getMetaInfo, M as flatMap, Ot as TASK, R as identity, S as check, St as IO, T as createAllStyleChildCallbacks, Tt as SAGA_ACTION, U as makeIterator, V as kTrue, W as none, X as remove, _ as asyncIteratorSymbol, _t as symbol$1, a as FLUSH, bt as CANCEL, c as JOIN, ct as buffer, d as SET_CONTEXT, dt as iterator, et as shouldComplete, f as TAKE, ft as notUndef, g as assignWithSymbols, gt as stringableFunc, ht as string$1, i as CANCELLED$1, j as expanding, k as detach, kt as TASK_CANCEL, l as RACE, lt as channel$1, mt as promise, n as CALL, o as FORK, ot as wrapSagaDispatch, pt as object, r as CANCEL$1, s as GET_CONTEXT, st as array$1, t as ACTION_CHANNEL, tt as shouldTerminate, u as SELECT, ut as func, v as buffers, vt as undef, wt as MULTICAST, xt as CHANNEL_END_TYPE, yt as _extends, z as internalErr } from "./io-e3db6b7a.development.esm-BN7enB45.js";
...
function proc(env, iterator$2, parentContext, parentEffectId, meta, isRoot, cont) {
	...
	*/
	function next(arg, isErr) {
		if (digesting && (digestingSemaphore === semaphore || digestingSemaphore > 0 && semaphore > digestingSemaphore)) {
			if (shouldCancel(arg)) {
				mainTask.status = CANCELLED;
				next.cancel();
			}
	...
	function digestEffect(effect, parentEffectId, cb, label) {
		...
		**/
		...
		function currCb(res, isErr) {
			...
			cb.cancel = noop;
			if (env.sagaMonitor) {
				if (isErr) env.sagaMonitor.effectRejected(effectId, res);
