...
function useOutlet(context) {
	...
	if (outlet) return /*#__PURE__*/ React.createElement(OutletContext.Provider, { value: context }, outlet);
	return outlet;
}
/**
...
var RenderErrorBoundary = class extends React.Component {
	...
	render() {
		return this.state.error !== void 0 ? /*#__PURE__*/ React.createElement(RouteContext.Provider, { value: this.props.routeContext }, /*#__PURE__*/ React.createElement(RouteErrorContext.Provider, {
...
var startTransitionImpl$1 = React["startTransition"];
/**
...
var AwaitErrorBoundary = class extends React.Component {
	...
	render() {
		...
		if (status === AwaitRenderStatus.error) return /*#__PURE__*/ React.createElement(AwaitContext.Provider, {
			value: promise,
			children: errorElement
		});
		if (status === AwaitRenderStatus.success) return /*#__PURE__*/ React.createElement(AwaitContext.Provider, {
			value: promise,
			children
		});
		throw promise;
...
var ViewTransitionContext = /*#__PURE__*/ React.createContext({ isTransitioning: false });
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = /*#__PURE__*/ React.createContext(/* @__PURE__ */ new Map());
FetchersContext.displayName = "Fetchers";
var startTransitionImpl = React["startTransition"];
var flushSyncImpl = ReactDOM["flushSync"];
var useIdImpl = React["useId"];
...
function RouterProvider(_ref) {
	...
	let routerFuture = React.useMemo(() => ({ v7_relativeSplatPath: router.future.v7_relativeSplatPath }), [router.future.v7_relativeSplatPath]);
